@extends('admin.admin')
@section('content')
    @vite('resources/css/prodi_dosen.css')
    @vite('resources/js/prodi_dosen.js')
    <div class="container">
        <div class="page ml-12" id="prodidosen">
            ...
            <form action="{{ url('admin/prodi_dosen') }}" method="POST">
                @csrf
            ...
            <div class="overflow-x-auto pb-2">
                <table class="table-auto mt-24 w-11/12 border-collapse">
                    ...
                    <tbody>
                        @foreach( $dataProdiDosen as $no => $value)
                        <tr>
                            ...
                            <td class="border px-4 py-2">
                                <button type="button" data-modal-target="edit_prodidosen_modal{{ $value->kode_prodi }}" data-modal-toggle="edit_prodidosen_modal" class="bg-blue-500 hover:bg-blue-700 text-white font-poppins font-normal py-1 px-2 rounded">Edit</button>
                                <a href="{{ url('admin/prodi_dosen/delete/'.$value->kode_prodi) }}">
...
<!-- ================================================MODAL EDIT================================================ -->
@foreach( $dataProdiDosen as $no => $value )
    <div id="edit_prodidosen_modal{{ $value->kode_prodi }}" tabindex="-1" aria-hidden="true" class="hidden h-screen modal flex overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center">
            ...
            <div class="relative p-4 w-full max-w-md max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                        ...
                        <button type="button" class="end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="edit_prodidosen_modal">
                    ...
                    <div class="p-4 md:p-5">
                        <form class="space-y-4" action="{{ url('admin/prodi_dosen/update/' .$value->kode_prodi) }}" method="POST">
                            @csrf
                            <div class="sm:col-span-2">
                                <label for="kode_prodi" class="block text-sm font-poppins font-semibold leading-6 text-gray-900">Kode Prodi</label>
                                <div class="mt-2">
