                        ...
                        <div class="flex flex-col">
                            <ul>
                                @foreach($dataKelas as $kelas)
                                    <li>
                                        <a href="{{ route('tampilJadwalKuliahKelas', $kelas->kode_kelas) }}" class="rounded-lg w-1/2 bg-gray-200 py-2 mt-3 flex justify-between px-4 shadow-md">
                                            <p class="font-poppins text-black">{{ $kelas->kode_kelas }}</p>
