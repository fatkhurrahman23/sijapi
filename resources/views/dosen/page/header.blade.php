            ...
            <div class="z-50 nav-links duration-500 md:static absolute md:min-h-fit min-h-[10vh] left-0 top-[-100%] md:w-auto w-full flex items-center px-5 ml-24">
                <ul class=" flex md:flex-row flex-col md:items-center md:gap-[3vw] gap-1 ">
                    ...
                    <li id="jadwal-nav" class="">
                        <a class="text-custom-putih hover:text-gray-500" href="{{ url('dosen/page/jadwal') }}">Jadwal</a>
                    </li>
                    <li id="presensi-nav" class="">
                        <a class="text-custom-putih hover:text-gray-500" href="{{ url('dosen/page/presensi') }}">Presensi</a>
                    </li>
                </ul>
            </div>
