            ...
            <div class="w-screen h-full justify-between flex mx-2 ">
                ...
                <div class="h-full w-full items-center  flex justify-between">
                    <ul class=" gap-12  mx-auto hidden sm:flex z-50">
                        <li><a href="{{ url('mahasiswa/page/beranda') }}" class="font-poppins font-normal text-custom-putih text-sm md:text-base lg:text-base ">Beranda</a></li>  
                        <li><a href="{{ url('mahasiswa/page/jadwal') }}" class="font-poppins font-normal text-custom-putih text-sm md:text-base lg:text-base ">Jadwal</a></li>
                        <li><a href="{{ url('mahasiswa/page/presensi') }}" class="font-poppins font-normal text-custom-putih text-sm md:text-base lg:text-base">Presensi</a></li>
                    </ul>
                </div>
                ...
                <div class="w-full items-center flex justify-center sm:justify-end md:justify-end lg:justify-end font-poppins -mr-8  sm:mr-12 md:mr-12 lg:mr-12 relative">
                    <p class="text-custom-silver sm:mr-2 md:mr-2 lg:mr-3 hidden font-poppins font-medium sm:text-base md:text-base lg:flex lg:text-base order-last sm:order-first md:order-first lg:order-first">{{ session('namaMhs') }}</p>
                    <div class="relative cursor-pointer group" onclick="toggleDropdown()">
                        ...
                        <div id="dropdownMenu" class="transition-opacity duration-300 ease-in-out absolute right-0 mt-2 w-48 bg-custom-abu opacity-95 border border-gray-200 rounded shadow-lg hidden">
                            <div class=" py-2  lg:hidden">
                                ...
                                <p class="block px-6 py-1  text-gray-800  font-poppins font-base text-xs">{{ session('namaMhs') }}</p>
                            </div>
                    ...
                    <ul class="flex mx-auto  justify-around w-full ">
                        <button>
                            <li class=" flex flex-col items-center justify-between gap-1">
                                ...
                                <a href="{{ url('mahasiswa/page/beranda') }}" class="font-poppins text-ls text-custom-kuning">Beranda</a>
                            </li>
                        </button>
                        <button>
                            <li class=" flex flex-col items-center justify-between gap-1">
                                ...
                                <a href="{{ url('mahasiswa/page/jadwal') }}" class="font-poppins text-ls text-custom-putih">Jadwal</a>
                            </li>
                        </button>
                        <button>
                            <li class=" flex flex-col items-center justify-between gap-1">
                                ...
                                <a href="{{ url('mahasiswa/page/presensi') }}" class="font-poppins text-ls text-custom-putih">Presensi</a>
                            </li>
                        </button>
