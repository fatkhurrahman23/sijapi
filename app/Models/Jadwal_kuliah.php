...
use Database\Seeders\tahunAkademik;
...
class Jadwal_kuliah extends Model
{
    ...
    protected $fillable = ['id', 'kode_jadwal_kuliah', 'kode_enrollment', 'kode_hari', 'kode_ruang', 'kode_kelas', 'kode_jam_awal', 'kode_jam_akhir', 'tahun_akademik', 'semester'];
